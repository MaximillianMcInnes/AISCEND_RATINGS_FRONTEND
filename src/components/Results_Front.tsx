...
const ResultsFront: React.FC<ResultsProps> = ({
  ...
  if (analysisType !== "front_profile" || !jsonData) {
    return (
      <div></div>
    );
  }

  const frontProfileData = jsonData.front_profile_data;
  const face = frontProfileData.front_profile.face
  const jawArea = frontProfileData.front_profile.jaw_area
  const eyes = frontProfileData.front_profile.eyes
  const lips = frontProfileData.front_profile.lips
  const Phenotype = frontProfileData.front_profile.Phenotype
      ...
      <div className="w-full max-w-4xl">
        ...
        <div className="p-4 rounded-lg shadow-lg text-center mb-4">
          ...
          <p className="text-4xl font-bold text-[#6934B3] drop-shadow-[0_0_10px_rgba(105,52,179,0.7)]">
            {frontProfileData.Scores.overall}/10
          </p>
        </div>
        ...
        <div className="p-4 rounded-lg shadow-lg text-center mb-4">
          ...
          <p className="text-4xl font-bold text-[#6934B3] drop-shadow-[0_0_10px_rgba(105,52,179,0.7)]">
            {frontProfileData.Scores.potential}/10
          </p>
        </div>
        ...
        <div className="bg-[#111112FF] p-8 rounded-3xl shadow-lg text-center">
            ...
            <p className="text-xl font-bold mb-4">
              ...
              <span className="text-[#723EBAFF] font-bold">
                {" "}
                {frontProfileData.Scores.Face}/10
              </span>
            </p>
