...
const FloatingDockDesktop = ({
  ...
  return (
    <motion.div
      ...
      className={cn(
        "fixed bottom-0 left-1/2 transform -translate-x-1/2 z-[999] mx-auto flex h-20 gap-6 items-end rounded-2xl bg-gray-50 dark:bg-neutral-900 px-6 pb-5 shadow-lg outline outline-1 outline-gray-200 dark:outline-neutral-700",
        className
      )}
    >
      {items.map((item) => (
